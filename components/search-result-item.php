        ...
        <div class="ukn-search-result-item" data-search-result data-result-type="<?= htmlspecialchars($result['type']) ?>">
          ...
          <?php if ($result['type'] === 'mentor' && $result['department'] && $result['skill']): ?>
            <button
              ...
              data-request-avatar-url="<?= htmlspecialchars((string) uknAvatarUrl($result['avatar_path'] ?? null)) ?>"
          ...
          <?php endif; ?>
          <?php if (in_array($result['type'], ['mentor', 'learner'], true) && $result['following'] !== null && !empty($result['memberId'])): ?>
